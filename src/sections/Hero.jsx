      ...
      <section className="relative pt-60 pb-40 max-lg:pt-52 max-lg:pb-36 max-md:pt-36 max-md:pb-32">
        <Element name="hero">
          <div className="container relative z-2 flex flex-col lg:flex-row items-start lg:items-center">
            ...
            {/* Hero Image – positioned differently by screen size */}
            <div className="mt-12 lg:mt-0 lg:absolute lg:top-[30vh] lg:right-0 lg:w-[60%] lg:max-w-[800px] pointer-events-none">
              <div className="relative overflow-hidden rounded-[2rem] shadow-2xl transform rotate-[-1deg] lg:rotate-[-1deg]">
                {/* left fade overlay */}
