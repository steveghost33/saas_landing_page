            ...
            <Element name="services">
                <div className="container">
                    <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col services-after md:g7 max-md:border-none max-md:rounded-none max-md:gap-3">
                        ...
                        {[...services].reverse().map(({ id, icon, caption, title, text, button }) => (
                            <div
                                key={id}
                                className="relative z-2 flex-50 md:px-10 px-5 md:pb-10 pb-5 max-md:g7 max-md:border-2 max-md:border-s3 max-md:rounded-3xl max-md:flex-320 flex flex-col justify-between"
                            >
                                <div>
